  ...
  <div class="home">
    <div class="header">
      ...
      <div class="wrapper--input">
        ...
        <input v-model="user_search_restaurant" type="text" placeholder="De quoi avez vous envie ?" name="search">
        <div class="search">
    ...
    setup() {
      ...
      function similarity(search, value) {
        ...
        for (let i = 0; i < value.length; i +=1 ) {
          ...
          chunks.push(fastlenvenshtein(search.toLowerCase(), chunk.toLowerCase()))
        }
      ...
      watch(user_search_restaurant, new_value => {
        search_restaurant.value = all_restaurant.slice().sort((a,b) => similarity(new_value, a.name) - similarity(new_value, b.name)).slice(0, 5)
      })
      //
